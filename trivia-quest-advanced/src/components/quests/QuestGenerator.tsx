...
import { Calendar, Clock, Trophy, Star, ChevronRight, RefreshCw, CheckCircle, Timer, TrendingUp, Sparkles, ArrowLeft } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="absolute top-0 left-0 z-10">
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gray-800/70 backdrop-blur-sm text-gray-300 rounded-lg hover:bg-gray-700/70 transition-all duration-300"
          >
