...
const Quiz: React.FC<QuizProps> = React.memo(({ onNavigateHome, userStats, updateUserStats, isLoading: userStatsLoading, initialCategory, initialTheme, initialDifficulty }) => {
  ...
  const {
    ...
    difficulty,
    selectedAnswer
  } = useQuizFlow(onAnswerCallback, () => onQuizCompleteRef.current(), initialCategory, initialTheme, initialDifficulty);
