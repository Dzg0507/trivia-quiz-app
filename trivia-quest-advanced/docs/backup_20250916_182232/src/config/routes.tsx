...
const MultiplayerLobby = lazy(() => import('../components/MultiplayerLobby.tsx'));
const MultiplayerGame = lazy(() => import('../components/MultiplayerGame.tsx'));
const QuestWorld = lazy(() => import('../components/QuestWorld.tsx'));
const QuestGenerator = lazy(() => import('../components/QuestGenerator.tsx'));
