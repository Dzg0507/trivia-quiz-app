    ...
    return (
        ...
        >
            ...
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={south} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={north} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={structures} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={land1} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={land2} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={land3} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={land5} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={land4} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.012}
            >
                <meshLambertMaterial map={land6} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            {isSelected && (
                <mesh scale={0.0122}> {/* Slightly larger scale for the rim */}
                    <sphereGeometry args={[1, 32, 32]} />
                    <meshBasicMaterial
                        color={0x88ccff}
                        transparent
                        opacity={0.2}
                        side={THREE.BackSide} // Only render the back faces for rim effect
                    />
                </mesh>
            )}
            <BlackHole />
