    ...
    return (
        <group {...props} dispose={null} ref={planet} onClick={() => onPlanetClick(name)}>
            ...
            <mesh
                ...
                scale={0.005}
            >
                <meshLambertMaterial map={seed} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.005}
            >
                <meshLambertMaterial map={ice} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.005}
            >
                <meshLambertMaterial map={vines} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            <mesh
                ...
                scale={0.005}
            >
                <meshLambertMaterial map={vines2} emissive={isSelected ? new THREE.Color(0x4488ff) : new THREE.Color(0x000000)} emissiveIntensity={isSelected ? 0.3 : 0} />
            </mesh>
            {isSelected && (
                <mesh scale={0.0052}> {/* Slightly larger scale for the rim */}
